...
6. Please include your test data under the "fixture" folder and your test scripts under the "e2e" folder. Utilize "commons.ts" to store common methods. Write any UI or API scripts related to your desired topic.
